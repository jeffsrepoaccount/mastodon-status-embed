import { r as registerInstance, h } from './index-5ee7bac7.js';
...
const mastodonStatusCss = "div.wrapper{border:1px solid #000;padding:0.5rem;border-radius:0.5rem}div.header{border-bottom:1px solid #aaa}div.content{font-size:1.3rem}div.footer{border-top:1px solid #aaa;padding-top:0.5rem;}div.footer i{margin:0 0.25rem}div.footer span{margin-right:0.25rem}div.footer span.right{float:right}span.footer-item{}span.avatar img{width:46px;margin-right:1rem}span.author{display:inline-block;height:46px;vertical-align:top}span.post-date{float:right}";
...
export { MastodonStatus as mastodon_status };
